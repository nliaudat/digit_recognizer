...
def generate_augmented_mixup_dataset():
    # Paths
    project_root = Path(__file__).resolve().parent.parent.parent
    tools_dir = project_root / "datasets" / "tools"
    output_base = project_root / "datasets" / "static_augmentation_mixup"
    output_images = output_base / "images"
    temp_output = output_base / "temp_aug"

    print("🛠️  Starting Augmented Mixup Dataset Generation...")
    ...
    for config_path in json_configs:
        ...
        # Run static_mixup_augmentation.py
    ...
    print("\n✨ Augmented Mixup Dataset Generation Complete!")
    print(f"📍 Files available in: {output_base}")

if __name__ == "__main__":
    generate_augmented_mixup_dataset()
