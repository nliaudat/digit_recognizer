...
def create_digit_recognizer_v13():
    ...
    # Initial Conv layer
    x = keras.layers.Conv2D(16, (3, 3), padding='same', kernel_initializer='he_normal', use_bias=False)(inputs)
    ...
    return keras.Model(inputs, outputs, name="digit_recognizer_v13")
