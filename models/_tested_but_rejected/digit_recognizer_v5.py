...
def create_digit_recognizer_v5_grayscale():
    ...
    x = keras.layers.Activation('relu6', name='relu6_1')(x)
    ...
    x = keras.layers.Activation('relu6', name='relu6_2')(x)
    ...
    x = keras.layers.Activation('relu6', name='relu6_3')(x)
    # Current: 10x16xfilters
    ...
    if params.NB_CLASSES >= 50:
        ...
        x = keras.layers.Activation('relu6', name='relu6_4')(x)
    ...
    x = keras.layers.Dense(dense_units, activation='relu', name='feature_dense')(x)
    x = keras.layers.Activation('relu6', name='relu6_dense')(x)
    
    # Optional: Additional dense layer for complex classification
    if params.NB_CLASSES >= 50:
        dense_units_2 = get_dense_units(48, 96)
        x = keras.layers.Dense(dense_units_2, activation='relu', name='feature_dense2')(x)
        x = keras.layers.Activation('relu6', name='relu6_dense2')(x)
    ...
    return keras.Model(inputs, outputs, name=f"digit_recognizer_v5_grayscale_{params.NB_CLASSES}classes")
...
def create_digit_recognizer_v5_rgb():
    ...
    if params.NB_CLASSES >= 50:
        x = keras.layers.Dense(get_dense_units(64, 96), activation='relu', name='feature_dense2')(x)
        x = keras.layers.Activation('relu6', name='relu6_dense2')(x)
    ...
    return keras.Model(inputs, outputs, name=f"digit_recognizer_v5_rgb_{params.NB_CLASSES}classes")
...
def create_digit_recognizer_v5_compact():
    ...
    return keras.Model(inputs, outputs, name=f"digit_recognizer_v5_compact_{params.NB_CLASSES}classes")
...
def create_digit_recognizer_v5_high_accuracy():
    ...
    x = keras.layers.Dense(get_dense_units(96, 160), activation='relu', name='feature_dense1')(x)
    x = keras.layers.Activation('relu6', name='relu6_dense1')(x)
    
    x = keras.layers.Dense(get_dense_units(64, 112), activation='relu', name='feature_dense2')(x)
    x = keras.layers.Activation('relu6', name='relu6_dense2')(x)
    ...
    return keras.Model(inputs, outputs, name=f"digit_recognizer_v5_high_acc_{params.NB_CLASSES}classes")
