"""
train_super_validator_legacy.py
===============================
[LEGACY] Standalone training script for super_high_accuracy_validator.
This script has been merged into train.py.
...
Usage:
  python train_super_validator_legacy.py
  python train_super_validator_legacy.py --epochs 300 --batch 64 --lr 1e-3
  python train_super_validator_legacy.py --no-mixup --no-mixed-precision
"""
...
def main():
    print("\n" + "="*80)
    print("WARNING: YOU ARE RUNNING A LEGACY SCRIPT.")
    print("The features of train_super_validator.py have been merged into train.py.")
    print("Please use train.py for future training.")
    print("="*80 + "\n")
    args = parse_args()
    has_gpu = setup_gpu()
...
# python train_super_validator_legacy.py --output-dir exported_models/100cls_RGB/super_high_accuracy_validator_100cls_RGB_v2 --focal-gamma 4
